<script lang="ts">
	...
	const navGroups: NavGroup[] = [
		{
			label: 'Platform',
			items: [
				{ href: '/superadmin', label: 'PHC Overview', icon: Building2 },
				{ href: '/superadmin/users', label: 'All Users', icon: Users },
				{ href: '/superadmin/permissions', label: 'Permissions Audit', icon: ShieldCheck }
			]
		},
		{
			label: 'Distribution',
			items: [
				{ href: '/superadmin/releases', label: 'App Releases', icon: Download },
	...
	const bottomNavItems: BottomNavItem[] = [
		...
		{ href: '/superadmin/permissions', label: 'Audit', icon: ShieldCheck },
		{ href: '/superadmin/system', label: 'Health', icon: ServerCrash },
