<script lang="ts">
  ...
  import {
    BarChart3, FolderOpen, Users, CalendarDays,
    Shield, Activity, FileText, SlidersHorizontal,
    Bell, Settings, Sun, Moon, Monitor
  } from '@lucide/svelte';
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      label: 'System',
      items: [
        { href: '/superadmin', label: 'Makers Dashboard', icon: Shield },
      ],
    },
  ];
