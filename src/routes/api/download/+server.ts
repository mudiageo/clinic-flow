...
export async function GET({ url }) {
  ...
  if (os === 'windows') {
    ...
    redirect(302, 'https://github.com/mudiageo/clinic-flow/releases/download/v1.0.0/ClinicFlow_1.0.0_x64_en-US.msi');
  } else if (os === 'android') {
    // Redirect to a mock APK release URL
    redirect(302, 'https://github.com/mudiageo/clinic-flow/releases/download/v1.0.0/ClinicFlow_1.0.0_arm64.apk');
  }
