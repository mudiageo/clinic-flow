...
<div class="container mx-auto px-4 md:px-8 max-w-2xl py-16 animate-fade-in flex-1">
	<div class="text-center mb-10">
		<div
			class="size-16 rounded-2xl bg-primary/10 text-primary flex items-center justify-center mx-auto mb-6"
		>
			...
			<div class="space-y-4">
				...
				<div class="space-y-2">
					...
					<div class="relative">
						...
						<Input
							{...registerAction.fields.phcName.as('text')}
							id="phcName"
							placeholder="e.g. Oredo PHC"
							class="pl-10"
						/>
					</div>
				...
				<div class="grid grid-cols-2 gap-4">
					<div class="space-y-2">
						...
						<div class="relative">
							...
							<Input
								{...registerAction.fields.state.as('text')}
								id="state"
			...
			<div class="space-y-4">
				...
				<div class="space-y-2">
					...
					<div class="relative">
						...
						<Input
							{...registerAction.fields.adminName.as('text')}
							id="adminName"
				...
				<div class="space-y-2">
					...
					<div class="relative">
						...
						<Input
							{...registerAction.fields.email.as('email')}
							id="email"
							placeholder="admin@phc.gov.ng"
							class="pl-10"
						/>
					</div>
