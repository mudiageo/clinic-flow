				...
				<div class="p-6" in:slide={{ duration: 300 }}>
					...
					<div class="space-y-6">
						<div class="space-y-3">
							...
							/>
							<p class="text-sm text-muted-foreground">For security, connecting to a cloud server requires a Pairing QR Code or Link generated by your Admin. Direct URL entry is disabled for kiosks.</p>
						</div>
